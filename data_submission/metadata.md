...
- A participant must only have one demographics record. Duplicate HTAN Participant ID records will trigger an error. Other clinical metadata also have restrictions in the number of records per participant. Please see [Phase 2 Clinical Data](clin_data_submission.md) for more information.
